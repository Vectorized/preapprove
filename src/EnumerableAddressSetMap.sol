...
library EnumerableAddressSetMap {
    ...
    function add(Map storage sm, address key, address value) internal returns (bool) {
    ...
    function remove(Map storage sm, address key, address value) internal returns (bool) {
